...
public class DanhSachHangHoa {
    ...
    public void thongKeDGHH() {
        ...
        System.out.println("Tong don gia hang hoa: " + tongDGHH + " dong");
        System.out.println("Tong don gia hang Dien May: " + tongDGHangDM + " dong");
        System.out.println("Tong don gia hang Thuc Pham: " + tongDGHangTP + " dong");
        System.out.println("Tong don gia hang Sanh Su: " + tongDGHangSS + " dong");
    }
